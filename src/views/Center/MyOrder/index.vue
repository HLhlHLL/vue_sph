<template>
  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <table class="order-item" v-for="(order, index) in orderList" :key="index">
          <thead>
            <tr>
              <th colspan="5">
          ...
          <tbody>
            <tr v-for="(skuInfo, index) in order.orderDetailList" :key="index">
              <td width="60%">
                <div class="typographic">
                  <img :src="skuInfo.imgUrl" style="width: 100px" />
                  <a class="block-text">{{ skuInfo.skuName }}</a>
                  <span>x{{ skuInfo.skuNum }}</span>
...
export default {
  ...
  methods: {
    async getMyOrderList() {
      const { data: res } = await this.$http.reqMyOrderList(this.queryInfo)
      if (res.code === 200) {
