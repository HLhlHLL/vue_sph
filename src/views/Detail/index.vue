      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            ...
            <div class="priceArea">
              <div class="priceArea1">
                ...
                <div class="price">
                  <i>¥</i>
                  <em style="margin: 0 3px">{{ skuInfo.price }}</em>
                  <span>降价通知</span>
                </div>
                <div class="remark">
                  <i>累计评价</i>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="saleAttr in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd
                  ...
                  :key="saleValue.id"
                  @click="selectAttr(saleValue, saleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model.number="skuNum" @blur="checkSkuNmu" />
...
export default {
  ...
  mounted() {
    this.$store.dispatch('getGoodDetails', this.$route.params.skuid)
  },
  computed: {
