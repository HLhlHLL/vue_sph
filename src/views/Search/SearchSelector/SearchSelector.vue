  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="(item, index) in trademarkList" :key="index" @click="getTradeMark(item)">{{ item.tmName }}</li>
        </ul>
      </div>
      <div class="ext">
    ...
    <div class="type-wrap" v-for="item in attrsList" :key="item.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(i, index) in item.attrValueList" :key="index" @click="getAttrInfo(item, i)">
            <a>{{ i }}</a>
          </li>
        </ul>
      </div>
